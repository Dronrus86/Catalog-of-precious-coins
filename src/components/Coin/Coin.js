        ...
        return (
            <div className='coin_container'>
                <div className='coin_container_img'>
                    <div>
                        <image>
                            <img className="list_img" src="../img_coin/25cents_1.png" alt="img"/>
                        </image>
                    </div>
                    <div>
                        <image>
                            <img className="list_img" src="../img_coin/25cents_2.png" alt="img"/>
                        </image>
                    </div>
                </div>
                ...
                <div className='coin_container_title'>
                    ...
                    <p className='coin_container_text'>"Canadian beaver". Unique coin with the image of a beaver. Face
                    ...
                    <span className='link_coin_home'><Link to="/show/bullion"> Back to the list</Link></span>
                </div>
            </div>
        );
    }
